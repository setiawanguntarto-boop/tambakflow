...
export const Header = () => {
  ...
  return (
    <header className="bg-gradient-ocean text-primary-foreground shadow-ocean sticky top-0 z-50">
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="md:hidden bg-primary-dark text-center pb-4 space-y-2">
          <a
            href="#about"
